...
static const PalabraClave palabras_clave[] = {
    ...
    {"AGREGARHECHO", TOK_AGREGARHECHO},
    {"AGREGARREGLA", TOK_AGREGARREGLA},
    {"CONSULTAR", TOK_CONSULTAR},
    {"LIMPIARLOGICA", TOK_LIMPIARLOGICA},
    {"LISTARHECHOS", TOK_LISTARHECHOS},
    {"LISTARREGLAS", TOK_LISTARREGLAS},
    {"BUSCARTODOS", TOK_BUSCARTODOS},
...
const char* lexer_nombre_token(TipoToken tipo) {
    switch (tipo) {
        ...
        // Motor lógico
        case TOK_AGREGARHECHO:
            return "AGREGARHECHO";
        case TOK_AGREGARREGLA:
            return "AGREGARREGLA";
        case TOK_CONSULTAR:
            return "CONSULTAR";
        case TOK_LIMPIARLOGICA:
            return "LIMPIARLOGICA";
        case TOK_LISTARHECHOS:
            return "LISTARHECHOS";
        case TOK_LISTARREGLAS:
            return "LISTARREGLAS";
        case TOK_BUSCARTODOS:
            return "BUSCARTODOS";
