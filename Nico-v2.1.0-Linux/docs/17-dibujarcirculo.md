...
El comando `DIBUJARCIRCULO` utiliza un algoritmo paramétrico basado en trigonometría:
1. Recorre un bucle angular desde `0` hasta `2π`
2. Calcula coordenadas discretas usando `COSENO` y `SENO`
3. Posiciona el cursor y dibuja cada punto de la circunferencia
4. Repite hasta completar el círculo

💡 **Nota:** Asegurate de que el círculo completo entre en el área visible de la terminal. Si el radio es muy grande o el centro está cerca de los bordes, parte del círculo puede quedar fuera del área visible.
...
---
📚 **Validado con Nico v2.1.0**. Compatible con Linux, Windows y Raspberry Pi.
